...
export default {
  ...
  patchDetails: {
    ...
    noPatch: "No patch",
    note: "From 1 June 2026, housing services in this area are managed by a Neighbourhood Lead. To raise a query about this property, please use the triage form.",
